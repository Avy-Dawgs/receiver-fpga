...
set_output_delay -clock pga_sck_mmcm -max 8 [get_ports pio42] 
set_output_delay -clock pga_sck_mmcm -min 6 [get_ports pio42] 
# CS_N
# half period is 20 ns, need 15 ns setup time, 0 ns hold time
set_output_delay -clock pga_sck_mmcm -max 4 [get_ports pio44] -clock_fall
