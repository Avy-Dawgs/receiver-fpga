...
set_output_delay -clock adc_sck_mmcm -max 0.7 [get_ports pio16] 
# 5 ns cs_n rising setup after sck fallling 
set_output_delay -clock adc_sck_mmcm -min -0.7 [get_ports pio16] 
# MISO 
# estimate trace delay (both directions) as 1 ns, sdo hold time is 1ns
set_input_delay -clock adc_sck_mmcm -max 5 [get_ports pio20] -clock_fall 
set_input_delay -clock adc_sck_mmcm -min 3 [get_ports pio20] -clock_fall 
